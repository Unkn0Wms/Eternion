...
<head>
    <meta charset="UTF-8">
    <title>Eternion » Документы</title>
...
<main class="container  " style="flex-grow: 1;  display: flex; margin-top: 8%;
    ...
    <div class="cont ">
        ...
        <text style="white-space: pre-line;">
            ...
            Настоящее Пользовательское соглашение (далее – Соглашение) регулирует отношения между ЭКСЕЛЛЕНТКЛИЕНТ - владельцем интернет-ресурса Eternion - и любым физическим лицом - Пользователем интернет-ресурса Eternion
